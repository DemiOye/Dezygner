...
<html lang="en">
    <head>
        ...
        <style>
            ...
            body { margin: 0; background-color: #fc970d; display: flex; flex-direction: column; font-family: Source Sans Pro, Arial, Helvetica, Sans-serif; letter-spacing: 0.5px }
            ...
            .not-found { padding-top: 100px; padding-bottom: 200px; padding-left: 25px; padding-right: 25px; color: white; font-size: 22px }
            .not-found span { font-size: 250px }

            @media screen and (max-width: 500px) {
                .not-found { font-size: 18px }
                .not-found span { font-size: 200px }
            }
